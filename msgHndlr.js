...
module.exports = msgHandler = async (client, message) => {
	...
	case '#stiker':
	    ...
	    if (isMedia) {
                try {
                    ...
                    var result = await removeBackgroundFromImageBase64({ base64img, apiKey: '1d4MSpiPQ5sjQ1AkhrYf2Ttk', size: 'auto', type: 'auto', outFile })
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://www.whatsapp.com/', donate)
            break
        case '!tts':
	...
	case 'menu':
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://www.whatsapp.com', info)
            break
        case '!snk':
